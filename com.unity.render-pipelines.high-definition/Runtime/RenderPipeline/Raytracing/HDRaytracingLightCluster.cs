...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    class HDRaytracingLightCluster
    {
        ...
        void BuildLightData(CommandBuffer cmd, HDCamera hdCamera, HDRayTracingLights rayTracingLights, DebugDisplaySettings debugDisplaySettings)
        {
            ...
            var globalConfig = HDGpuLightList.CreateGpuLightDataJobGlobalConfig.Create(hdCamera, hdShadowSettings);
            ...
            for (int lightIdx = 0; lightIdx < lightEntities.lightCount; ++lightIdx)
            {
                ...
                processedLightEntity.dataIndex = lightIdx;
                ...
                ref HDLightRenderData lightRenderData = ref lightEntities.GetLightData(lightIdx);
                HDGpuLightList.CreateGpuLightDataJob.ConvertLightToGPUFormat(
                    lightCategory, gpuLightType, globalConfig,
                    lightComponent.lightShadowCasterMode, lightComponent.bakingOutput,
                    visibleLight, processedLightEntity, lightRenderData, ref lightData);
