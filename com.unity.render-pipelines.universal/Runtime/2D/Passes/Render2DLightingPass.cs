...
namespace UnityEngine.Rendering.Universal
{
    internal class Render2DLightingPass : ScriptableRenderPass, IRenderPass2D
    {
        ...
        private void CopyCameraSortingLayerRenderTexture(ScriptableRenderContext context, RenderingData renderingData, RenderBufferStoreAction mainTargetStoreAction)
        {
            ...
            cmd.SetRenderTarget(colorAttachmentHandle.nameID, RenderBufferLoadAction.Load, mainTargetStoreAction,
                depthAttachmentHandle.nameID, RenderBufferLoadAction.Load, mainTargetStoreAction);
            ...
            ref RenderTextureDescriptor desc)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingDrawRenderers))
            {
                ...
                cmd.SetRenderTarget(colorAttachmentHandle.nameID, RenderBufferLoadAction.Load, initialStoreAction, depthAttachmentHandle.nameID, RenderBufferLoadAction.Load, initialStoreAction);
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            else
            {
                ...
                {
                    cmd.SetRenderTarget(colorAttachmentHandle.nameID, RenderBufferLoadAction.Load, storeAction, depthAttachmentHandle.nameID, RenderBufferLoadAction.Load, storeAction);
